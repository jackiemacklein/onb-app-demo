      ...
      <Fragment>
        <div className="rui-profile row vertical-gap">
                ...
                <div className="row vertical-gap">
                  ...
                  <div className="col">
                    <div className="rui-profile-info">
                      ...
                      <Link className="rui-profile-info-mail" to="#">
                        info@example.com
                      </Link>
                      <Link className="rui-profile-info-phone" to="#">
                        +44 987 065 909
                      </Link>
                    </div>
                  </div>
                ...
                <ul className="list-group list-group-flush rui-profile-task-list">
                    ...
                    <div className="rui-task rui-task-success">
                      ...
                      <div className="rui-task-content">
                        <Link className="rui-task-title" to="/task">
                          Cattle whose. There isn&apos;t cattle rule said saying you divided
                        </Link>
                        <small className="rui-task-subtitle">
                          #12 opened 4 days ago by <Link to="#">Henry</Link>
                        </small>
                      </div>
                    </div>
                  </li>
                  <li className="list-group-item">
                    <div className="rui-task rui-task-success">
                      ...
                      <div className="rui-task-content">
                        <Link className="rui-task-title" to="/task">
                          Was living rule Him created a to. Light of itself
                        </Link>
                        <small className="rui-task-subtitle">
                          #11 opened 21 days ago by <Link to="#">Neil</Link>
                        </small>
                      </div>
                    </div>
                  </li>
                  <li className="list-group-item">
                    <div className="rui-task rui-task-danger">
                      ...
                      <div className="rui-task-content">
                        <Link className="rui-task-title" to="/task">
                          The problem with the Media object
                        </Link>
                        <small className="rui-task-subtitle">
                          #10 closed on 12 Mar by <Link to="#">Anna</Link>
                        </small>
                      </div>
          ...
          <div className="col-12">
            <Tabs sliding>
              <Tabs.NavItem isActive={activeTab === "activity"} onClick={() => this.toggleTab("activity")}>
                Activity
              </Tabs.NavItem>
              <Tabs.NavItem isActive={activeTab === "timeline"} onClick={() => this.toggleTab("timeline")}>
                Timeline
              </Tabs.NavItem>
              <Tabs.NavItem isActive={activeTab === "settings"} onClick={() => this.toggleTab("settings")}>
                Settings
              </Tabs.NavItem>
            </Tabs>
            <Tabs.Content activeTab={activeTab}>
                ...
                <ul className="list-group list-group-flush rui-profile-activity-list">
                    ...
                    <div className="media media-retiring media-success">
                      <Link to="#" className="media-link">
                        <span className="media-img">
                          <img src={settings.users[1].img} alt="" />
                        </span>
                        <span className="media-body">
                          ...
                          <small className="media-subtitle">
                            Without air upon two was. Their stars. Days whose earth. Grass whales there living third shall is...
                          </small>
                        </span>
                      </Link>
                  ...
                  <li className="list-group-item">
                    <div className="media media-retiring media-warning">
                      <Link to="#" className="media-link">
                        <span className="media-img">
                          <img src={settings.users[2].img} alt="" />
                        </span>
                        <span className="media-body">
                          <span className="media-title">
                  ...
                  <li className="list-group-item">
                    <div className="media media-retiring media-danger">
                      <Link to="#" className="media-link">
                        <span className="media-img">
                          <img src={settings.users[3].img} alt="" />
                        </span>
                        <span className="media-body">
                          <span className="media-title">
                    ...
                    <div className="media media-retiring">
                      <Link to="#" className="media-link">
                        <span className="media-img bg-transparent">
                          <img src={settings.img_file.zip} className="icon-file" alt="" />
                        </span>
                        <span className="media-body">
                          <span className="media-title">
              ...
              <Tabs.Pane tabId="timeline">
                <Timeline lg="left">
                  <Timeline.Item icon={<Icon name="check-circle" />} date={"Jan 14"}>
                    <h3>Fifth moveth, void second.</h3>
                    <p>
                      Behold of them fruit own, void, also upon sixth fill their of said life he saw were the moving saw created herb second morning fruit.
                  ...
                  <Timeline.Item icon={<Icon name="award" />} date={"Jan 15"} swap>
                    <h3>Can&apos;t dry fly.</h3>
                    <p>
                      Likeness they&apos;re every give moved above moveth, herb days a rule behold seed is second night behold sea. Under given waters made
                      wherein behold void form land.
                    </p>
                    <button type="button" className="btn btn-brand">
                      Read More
                    </button>
                      ...
                      <div className="card">
                        <div className="card-body">
                          <div className="row vertical-gap sm-gap justify-content-end">
                            ...
                            <div className="col-auto">
                              <button className="btn btn-grey-2" type="button">
                                Cancel
                              </button>
                            </div>
                            <div className="col-auto">
