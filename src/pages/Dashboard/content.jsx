  ...
  render() {
    return (
      <Fragment>
        ...
        <Row className="vertical-gap">
          <Col lg="4">
            <WidgetMemory getChartjsData={this.getChartjsData} getChartjsOptions={this.getChartjsOptions} />
          </Col>
          <Col lg="4">
            <WidgetDisc getChartjsData={this.getChartjsData} getChartjsOptions={this.getChartjsOptions} />
          </Col>
          <Col lg="4">
            <WidgetCPU getChartjsData={this.getChartjsData} getChartjsOptions={this.getChartjsOptions} />
          </Col>
        </Row>
